from sam2_train.Unet.hardnet import HarDNet
from sam2_train.Unet.base import *
...
class Unet(nn.Module):
    def __init__(self, order=85, depth_wise=False, args=None):
...
class ModelEmb(nn.Module):
    def __init__(self, args):
        ...
        self.backbone = HarDNet(depth_wise=False, arch=85, args=None)
        d, f = self.backbone.full_features, self.backbone.features

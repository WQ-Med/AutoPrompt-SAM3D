...
class SAM2UNet(nn.Module):
    def __init__(self, checkpoint_path=None) -> None:
        ...
        n_fileter = [96,192,384,768]  #源代码是[144,288,576,1152]

        self.rfb1 = RFB_modified(n_fileter[0], 64)
        self.rfb2 = RFB_modified(n_fileter[1], 64)
        self.rfb3 = RFB_modified(n_fileter[2], 64)
        self.rfb4 = RFB_modified(n_fileter[3], 64)
        self.up1 = (Up(128, 64))
        self.up2 = (Up(128, 64))
        self.up3 = (Up(128, 64))
        self.up4 = (Up(128, 64))

...
from sam2_train.modeling.sam.new_mask_decoder import MaskDecoder
...
class SAM2Base(torch.nn.Module):
    ...
    def _build_sam_heads(self):
        ...
        #这是我自己用的new_mask_decoder
        self.sam_mask_decoder = MaskDecoder(
            num_multimask_outputs=3,
            image_embedding_size = self.sam_image_embedding_size, #这个改动是我添加的，注意了！
